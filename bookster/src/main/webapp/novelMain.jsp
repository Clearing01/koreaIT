...
<div class="searchform">
	<form action="novelMain.do">
		...
		<tr>
	    	<td  style="border:none;" ><select name="searchCondition" class="search-td1">
				<option value="Ntitle">소설명</option>
				<option value="Nwriter">작가</option>
				<option value="Ngenre">장르</option>
			</select></td>
			<td style="border:none;"><input type="text" name="searchContent" placeholder="작품명, 작가, 장르를 검색해 보세요."></td>
